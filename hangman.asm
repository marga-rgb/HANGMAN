...
guessPrompt db 0Dh,0Ah,"Enter a letter (or '0' for hint): $"
...
post_guessed:
    ...
    ; check hint request '0' FIRST before uppercase conversion
    mov al, bl
    cmp al, 48          ; ASCII code for '0' (decimal)
    je check_hint
    ...
    sub al,32
skip_case:
    mov bl, al          ; save processed character back to BL
    jmp not_hint
